...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.edtName, 1);
        sViewsWithIds.put(R.id.edtEmail, 2);
        sViewsWithIds.put(R.id.edtMobileNo, 3);
        sViewsWithIds.put(R.id.btn5Rs, 4);
        sViewsWithIds.put(R.id.btn10Rs, 5);
        sViewsWithIds.put(R.id.btn15Rs, 6);
        sViewsWithIds.put(R.id.btn50Rs, 7);
    }
    // views
    @NonNull
